...
imean = data['meta']['normalization'][0][0][0][0][2]
...
# lr_lab = list(np.logspace(-1.5,-5,200))
# lr_img = list(np.logspace(-1.5,-5,200))
# lr_txt = list(np.logspace(-1.5,-5,200))
# lr_dis = list(np.logspace(-1.5,-5,200))